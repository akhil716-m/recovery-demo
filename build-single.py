...
(function(){
  ...
  function renderLanding(){
    ...
    // soft dot-grid texture, fading out toward the edges so the centre of the
    // page stays clean for the hero
    var bgsvg = el('div','position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;overflow:hidden;-webkit-mask-image:radial-gradient(ellipse 90% 85% at 50% 45%,transparent 28%,#000 78%);mask-image:radial-gradient(ellipse 90% 85% at 50% 45%,transparent 28%,#000 78%)');
    bgsvg.innerHTML =
      '<svg width="100%" height="100%" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">'
      +'<defs><pattern id="rr-dots" width="26" height="26" patternUnits="userSpaceOnUse"><circle cx="1.5" cy="1.5" r="1.5" fill="'+OL(_L?0.10:0.12)+'"/></pattern></defs>'
      +'<rect width="1600" height="900" fill="url(#rr-dots)"/>'
      +'</svg>';
