...
(function(){
  ...
  function renderLanding(){
    ...
    subp.textContent = 'Explore how Revenue Recovery analyzes payment failures, predicts the best retry opportunities, and recovers revenue automatically.';
    var cta = btn('Explore recovery flow','padding:14px 36px;border-radius:10px;border:none;background:'+BRAND+';color:#fff;font-size:15px;font-weight:600;cursor:pointer;font-family:inherit;box-shadow:0 8px 20px rgba(0,109,249,0.25);transition:transform .15s ease,box-shadow .15s ease',
